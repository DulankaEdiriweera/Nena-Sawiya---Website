      ...
      <div className="contact-layout">
        ...
        <div className="contact-form-card">
          {submitted ? (
            <div className="success-msg">
              ...
              <button className="reset-btn" onClick={() => { setForm(initialForm); setSubmitted(false); }}>
                Send Another
              </button>
            </div>
          ) : (
        ...
        <div className="contact-info-card">
          ...
          <div className="info-image-wrap">
            <img src={contactImage} alt="NenaSawiya Platform" className="info-image" />
          ...
          <div className="info-body">
            ...
            <div className="info-card-sub">Discover more tools and support at:</div>
            <div className="info-card-email">nenasawiya.support@gmail.com</div>

            <div className="detail-rows">
              <div className="detail-row">
                <div className="detail-row-icon cyan"><EmailIcon /></div>
              ...
              <div className="detail-row">
                <div className="detail-row-icon gold"><PhoneIcon /></div>
                <div className="detail-row-text">
              ...
              <div className="detail-row">
                <div className="detail-row-icon purple"><LocationIcon /></div>
                <div className="detail-row-text">
            ...
            <div className="social-row">
              <button className="social-btn" aria-label="LinkedIn"><LinkedInIcon /></button>
              <button className="social-btn" aria-label="Facebook"><FacebookIcon /></button>
              <button className="social-btn" aria-label="Instagram"><InstagramIcon /></button>
            </div>
          </div>
