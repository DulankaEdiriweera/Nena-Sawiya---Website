...
const slides = [
  {
    ...
    description:
      "An AI-powered platform designed to enhance learning experiences for students across Sri Lanka.",
  },
  {
    base: slide2,
    hover: slide2Hover,
    label: "Research Project",
    title: "නැණ සවිය",
    subtitle: "Your Slide 2 Subtitle",
    description: "Your slide 2 description text here.",
  },
  {
    base: slide3,
    hover: slide3Hover,
    label: "Research Project",
    title: "නැණ සවිය",
    subtitle: "Your Slide 3 Subtitle",
    description: "Your slide 3 description text here.",
  },
  {
    base: slide4,
    hover: slide4Hover,
    label: "Research Project",
    title: "නැණ සවිය",
    subtitle: "Your Slide 4 Subtitle",
    description: "Your slide 4 description text here.",
  },
