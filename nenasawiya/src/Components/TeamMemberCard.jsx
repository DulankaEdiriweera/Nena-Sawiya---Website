...
const TeamMemberCard = ({ name, image, role, university, department, linkedin, email }) => {
  return (
      ...
      <div className="card team-card h-100 text-center">
        ...
        <div className="card-body">
          ...
          <div className="text-group mt-2">
            <p><strong>{role === "Group Member" ? "Undergraduate" : "Role"}</strong></p>
            <p>{university}</p>
          </div>
        ...
        <div className="card-links">
          ...
          {linkedin && (
            <a href={linkedin} target="_blank" rel="noreferrer" className="card-link">
